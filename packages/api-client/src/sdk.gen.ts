 ...
 * 分页读取或搜索公开文章标题和摘要
 */
export const publicPostsApiV1BlogPostsGet = <ThrowOnError extends boolean = false>(options?: Options<PublicPostsApiV1BlogPostsGetData, ThrowOnError>): RequestResult<PublicPostsApiV1BlogPostsGetResponses, PublicPostsApiV1BlogPostsGetErrors, ThrowOnError> => (options?.client ?? client).get<PublicPostsApiV1BlogPostsGetResponses, PublicPostsApiV1BlogPostsGetErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * 读取公开文章与安全渲染正文
 */
export const publicPostApiV1BlogPostsSlugGet = <ThrowOnError extends boolean = false>(options: Options<PublicPostApiV1BlogPostsSlugGetData, ThrowOnError>): RequestResult<PublicPostApiV1BlogPostsSlugGetResponses, PublicPostApiV1BlogPostsSlugGetErrors, ThrowOnError> => (options.client ?? client).get<PublicPostApiV1BlogPostsSlugGetResponses, PublicPostApiV1BlogPostsSlugGetErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * 分页读取有公开文章的分类或标签
 */
export const publicTaxonomiesApiV1BlogTaxonomyKindGet = <ThrowOnError extends boolean = false>(options: Options<PublicTaxonomiesApiV1BlogTaxonomyKindGetData, ThrowOnError>): RequestResult<PublicTaxonomiesApiV1BlogTaxonomyKindGetResponses, PublicTaxonomiesApiV1BlogTaxonomyKindGetErrors, ThrowOnError> => (options.client ?? client).get<PublicTaxonomiesApiV1BlogTaxonomyKindGetResponses, PublicTaxonomiesApiV1BlogTaxonomyKindGetErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * 读取公开分类或标签名称与文章数量
 */
export const publicTaxonomyApiV1BlogTaxonomyKindSlugGet = <ThrowOnError extends boolean = false>(options: Options<PublicTaxonomyApiV1BlogTaxonomyKindSlugGetData, ThrowOnError>): RequestResult<PublicTaxonomyApiV1BlogTaxonomyKindSlugGetResponses, PublicTaxonomyApiV1BlogTaxonomyKindSlugGetErrors, ThrowOnError> => (options.client ?? client).get<PublicTaxonomyApiV1BlogTaxonomyKindSlugGetResponses, PublicTaxonomyApiV1BlogTaxonomyKindSlugGetErrors, ThrowOnError>({
    responseType: 'json',
