...
- 腾讯云主账号已经完成企业认证。
- 使用免费的腾讯云 TCR 个人版。
- TCR 个人版命名空间为 `pinjie-fullstack-blog`。
- 已经创建三个私有镜像仓库：
  ...
  "statement": [
    {
      ...
      "resource": [
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/*"
      ],
      "effect": "allow"
    }
...
```json
{
  ...
  "statement": [
    ...
    },
    {
      ...
      "resource": [
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-backend",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-backend/*",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-web",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-web/*",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-admin",
        "qcs::tcr::uin/<主账号UIN>:repo/pinjie-fullstack-blog/pinjie-fullstack-admin/*"
      ]
    }
  ]
...
8. 描述填写“生产服务器只读拉取 pinjie-fullstack-blog 三个应用仓库”。
9. 不添加条件，不关联其他服务。
...
| 备注 | `pinjie-fullstack-blog 生产服务器 TCR 只读拉取` | 便于后续审计和轮换 |
...
```bash
docker pull ccr.ccs.tencentyun.com/pinjie-fullstack-blog/pinjie-fullstack-backend@sha256:<backend-digest>
docker pull ccr.ccs.tencentyun.com/pinjie-fullstack-blog/pinjie-fullstack-web@sha256:<web-digest>
docker pull ccr.ccs.tencentyun.com/pinjie-fullstack-blog/pinjie-fullstack-admin@sha256:<admin-digest>
```
