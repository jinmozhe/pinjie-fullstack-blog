...
export const repository = "jinmozhe/pinjie-fullstack-blog";
export const registry = "ccr.ccs.tencentyun.com/pinjie-fullstack-blog";
...
export function imageReference(app, value) {
  const prefix = `${registry}/pinjie-blog-${app}@sha256:`;
