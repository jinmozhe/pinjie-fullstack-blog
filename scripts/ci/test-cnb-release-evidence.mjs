    ...
    `${JSON.stringify({
      ...
      config: {
        Labels: {
          ...
          "org.opencontainers.image.source": "https://github.com/jinmozhe/pinjie-fullstack-blog",
        },
      },
    })}\n`,
    "utf8",
...
const createEnvironment = {
  ...
  CNB_REPO_SLUG: "pjwl/pinjie-fullstack-blog",
  CNB_BRANCH: "main",
  CNB_BUILD_ID: expectedBuildId,
  CNB_BUILD_WEB_URL: `https://cnb.cool/pjwl/pinjie-fullstack-blog/-/build/logs/${expectedBuildId}`,
};
...
try {
  ...
  await expectRejected("wrong build URL", (fixture) => {
    fixture.cnb.build_url = "https://cnb.cool/pjwl/pinjie-fullstack-blog/-/build/logs/123";
  });
