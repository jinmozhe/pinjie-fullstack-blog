...
readonly EXPECTED_NAMESPACE="pinjie-fullstack-blog"
readonly EXPECTED_SOURCE_REPOSITORY="https://github.com/jinmozhe/pinjie-fullstack-blog"
...
resolve_image() {
  case "${IMAGE_KEY:-}" in
    backend)
      ...
      IMAGE_NAME="pinjie-blog-backend"
      ;;
    web)
      IMAGE_DOCKERFILE="apps/web/Dockerfile"
      IMAGE_NAME="pinjie-blog-web"
      ;;
    admin)
      IMAGE_DOCKERFILE="apps/admin/Dockerfile"
      IMAGE_NAME="pinjie-blog-admin"
      ;;
    *)
