...
const expectedImages = {
  backend: "pinjie-blog-backend",
  web: "pinjie-blog-web",
  admin: "pinjie-blog-admin",
};
const expectedRegistry = "ccr.ccs.tencentyun.com";
const expectedNamespace = "pinjie-fullstack-blog";
const expectedSourceRepository = "https://github.com/jinmozhe/pinjie-fullstack-blog";
...
requireEqual(manifest.cnb.repository, "pjwl/pinjie-fullstack-blog", "CNB repository");
...
if (!buildUrl.pathname.startsWith("/pjwl/pinjie-fullstack-blog/-/build/")) {
